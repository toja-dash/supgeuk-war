...
function TermsInfo() {
  const terms = [
    ...
    {
      title: 'Type A',
      body: '동반 분산 매도. 기관과 외국인이 모두 -3.0% 이하로 매도하고, 가격이 평단 방어선을 이탈한 BREAKDOWN 상태입니다.',
    },
    {
      title: 'Type B',
      body: '동반 매집 구간. 기관과 외국인이 모두 +3.0% 이상으로 매수하는 구간입니다.',
    },
    {
      title: 'Type C',
      body: '외인 단독 유입. 외국인은 +3.0% 이상 매수하고 기관은 -3.0% 이하 매도하는 구간입니다.',
    },
    {
      title: 'Type D',
      body: '기관 방어 우위. 기관은 +3.0% 이상 매수하고 외국인은 -3.0% 이하 매도하는 구간입니다.',
    },
    {
      title: '신호 강도',
