...
function TermsInfo() {
  const terms = [
    ...
    {
      title: 'Type A / Q3',
      body: '기관과 외국인이 모두 강하게 매도하고, 가격이 기관 평단 방어선을 이탈한 위험 경고 구간입니다.',
    },
    {
      title: 'Type B / Q1',
      body: '기관과 외국인이 동시에 강하게 매수하는 쌍끌이 매수 구간입니다.',
    },
    {
      title: 'Type C / Q4',
      body: '외국인은 강하게 매수하고 기관은 강하게 매도하는 수급 충돌 구간입니다.',
    },
    {
      title: 'Type D / Q2',
      body: '기관은 강하게 매수하고 외국인은 강하게 매도하는 기관 방어 구간입니다.',
    },
    {
      title: '신호 강도',
    ...
    {
      title: '방어 상태',
      body: '현재가가 기관/외국인 20거래일 평균 매수단가 대비 어디에 있는지 보는 상태입니다. SAFE, LINE_TOUCH, BREAKDOWN 등으로 표시됩니다.',
    },
    {
      title: '5일/20일 후',
      body: '신호 발생일 종가 대비 5거래일, 20거래일 뒤 종가 수익률입니다. 휴장일은 제외한 거래일 기준입니다.',
    },
  ];
