...
class MarketSummary(Base):
    ...
    market_dominance_indi_kospi = Column(Float)
    market_dominance_inst_kospi = Column(Float)
    market_dominance_frgn_kospi = Column(Float)
    market_dominance_indi_kosdaq = Column(Float)
    market_dominance_inst_kosdaq = Column(Float)
    market_dominance_frgn_kosdaq = Column(Float)
